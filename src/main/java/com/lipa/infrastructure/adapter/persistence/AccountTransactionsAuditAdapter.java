...
@Component
public class AccountTransactionsAuditAdapter implements AccountTransactionsAuditPort {

    private final AuditEventJpaRepository repo;

    public AccountTransactionsAuditAdapter(AuditEventJpaRepository repo) {
        this.repo = repo;
    }
