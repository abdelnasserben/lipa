...
@Component
public class VerifyPinAuditAdapter extends AbstractJpaAuditAdapter implements VerifyPinAuditPort {

    public VerifyPinAuditAdapter(AuditEventJpaRepository repo) {
